...
const NewInstitution = props => {
  ...
  const handleSubmit = async (evt) => {
    ...
    if (!name || !phoneNumber) {
      ...
      try {
        const address = { streetName, number, cityName, uf, neighborhoodName, countryName, stateName, postalCode }
        const institution = { name, phoneNumber, description, wishlist, user }
